...
- [ ] **Phase 10: GitHub Foundations** — Schema, global toggle, project link config, and the degrade-don't-break `internal/github` base. (3/3 plans executed; gaps found in UAT — gh-gated enablement + copy)
...
| 10. GitHub Foundations | v1.3 | 4/5 | In Progress|  |
