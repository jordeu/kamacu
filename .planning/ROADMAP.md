...
- [x] 21-03-PLAN.md — internal/migrate Part 2: managed-path rewrite (D-15), git worktree repair, tmux-row cleanup (MIGRATE-02/03)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 21-04-PLAN.md — Wire Part 1/Part 2 into main.go + flip runtime socket/path/prefix literals (MIGRATE-01/03/05)
...
- [x] 23-02-PLAN.md — cleanuppanel.go: annotated GET list + force-remove + bulk clean-eligible + clear-pointer, wired with ghSvc (WTREE-01/02/03/04)

**Wave 3** *(blocked on 23-02 + 23-04)*

- [x] 23-03-PLAN.md — Settings section, per-project rows, force-remove & clean-eligible dialogs, D-01 blocked banner (WTREE-01/02/03/04)
